 ...
 * @property string $experienciaDocent
...
class Full extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('centro_sec, tipo_bach, centro_bach, nombre_tituniv, universidad_tituniv, nombre_mast, universidad_mast, titulo_dei, nivelIngles_idio, nivelFrances_idio, nivelAleman_idio, idiomaOtros_idio, nivelOtros_idio, titulo_titidio, entidad_titidio, funcion_exnd, time_exnd, funcion_dr, materia_dr, nombreCentro_dr, time_dr, descripcion_excul, localidad_excul, entidad_excul, descripcion_exrel, localidad_exrel, entidad_exrel, descripcion_exvol, localidad_exvol, entidad_exvol', 'length', 'max'=>45),

...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'nombreCentro'); ?>
		<?php echo $form->textField($model,'nombreCentro',array('size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'nombreCentro'); ?>
	</div>
